...
SMDR_COMPLEX SMDR_MW_1loop (void);
SMDR_COMPLEX SMDR_MW_1loopALT (void);
SMDR_COMPLEX SMDR_MW_2loopQCD (void);
SMDR_COMPLEX SMDR_MW_2loopnonQCD (void);
                        ...
                        SMDR_REAL *GammaWBreitWignerresult)
{
  ...
  if (loopOrder > 0.999)
    CM2W += ONELOOPFACTOR * SMDR_MW_1loop ();

  if (loopOrder > 1.499)
    CM2W += TWOLOOPFACTOR * SMDR_MW_2loopQCD ();

  if (loopOrder > 1.999)
    CM2W += TWOLOOPFACTOR * SMDR_MW_2loopnonQCD ();
...
{
  SMDR_COMPLEX result;
  SMDR_COMPLEX Lt, Lt2, Lt3, LmW, LmW2;
  SMDR_COMPLEX Wot, Wot2, Wot3, Wot4, Wot5, Wot6, Wot7, Wot8, Wot9, Wot10;
  SMDR_COMPLEX Wot11, Wot12, Wot13, Wot14, Wot15; 
  SMDR_COMPLEX Wot16, Wot17, Wot18, Wot19, Wot20;
  SMDR_COMPLEX Wot21, Wot22, Wot23, Wot24, Wot25; 
  SMDR_COMPLEX Wot26, Wot27, Wot28, Wot29, Wot30;
  SMDR_COMPLEX Wo4t, Wo4t2, Wo4t3, Wo4t4, Wo4t5; 
  SMDR_COMPLEX Wo4t6, Wo4t7, Wo4t8, Wo4t9, Wo4t10;
  SMDR_COMPLEX Wo4t11, Wo4t12, Wo4t13, Wo4t14, Wo4t15, Wo4t16;
  ...
  result = 12.829946099260708 + 24.95406018214205*Lt + 63.*Lt2 - 30.*Lt3 +
  (-23.80015921534439 - 54.69251283188904*Lt + 14.*Lt2)*Wot +
  (-2.326752833975707 - 17.873201467029787*Lt - 1.5*Lt2)*Wot2 +
  (-0.6996723214060172 - 7.495683520871487*Lt - 7.2*Lt2)*Wot3 +
  (0.19761889421924775 + 0.3956811795610211*Lt - 8.5*Lt2)*Wot4 +
  (-0.30740339446784376 + 4.870029650274908*Lt - 8.571428571428571*Lt2)*Wot5 +
  (-1.0846144468231562 + 7.363029973568822*Lt - 8.25*Lt2)*Wot6 +
  (-1.7965672698160584 + 8.738731203716155*Lt - 7.809523809523809*Lt2)*Wot7 +
  (-2.3699992481403176 + 9.468397861968038*Lt - 7.35*Lt2)*Wot8 +
  (-2.8084071590193536 + 9.814058778791825*Lt - 6.909090909090909*Lt2)*Wot9 +
  (-3.134056484931102 + 9.926537506341067*Lt - 6.5*Lt2)*Wot10 +
  (-3.370499819508688 + 9.895599328459785*Lt - 6.125874125874126*Lt2)*Wot11 +
  (-3.537877152264374 + 9.776230885201567*Lt - 5.785714285714286*Lt2)*Wot12 +
  (-3.6522337008526438 + 9.602920739819838*Lt - 5.476923076923077*Lt2)*Wot13 +
  (-3.7260011874892918 + 9.397706986132766*Lt - 5.196428571428571*Lt2)*Wot14 +
  (-3.7687106700007287 + 9.174866322236436*Lt - 4.9411764705882355*Lt2)*Wot15 +
  (-3.7876506243828247 + 8.943728755751117*Lt - 4.708333333333333*Lt2)*Wot16 +
  (-3.788401889440503 + 8.7104121045094*Lt - 4.495356037151703*Lt2)*Wot17 +
  (-3.7752513172939683 + 8.478915740720769*Lt - 4.3*Lt2)*Wot18 +
  (-3.7515049004981544 + 8.25182432307295*Lt - 4.120300751879699*Lt2)*Wot19 +
  (-3.7197228718053226 + 8.030768618183657*Lt - 3.9545454545454546*Lt2)*Wot20 +
  (-3.6818959453000737 + 7.816731898461961*Lt - 3.801242236024845*Lt2)*Wot21 +
  (-3.639577697904284 + 7.610256359912698*Lt - 3.659090909090909*Lt2)*Wot22 +
  (-3.5939843974686445 + 7.411583746413333*Lt - 3.5269565217391303*Lt2)*Wot23 +
  (-3.546070656948575 + 7.220752045391992*Lt - 3.4038461538461537*Lt2)*Wot24 +
  (-3.496587083004383 + 7.0376624735828095*Lt - 3.2888888888888888*Lt2)*Wot25 +
  (-3.4461244538106426 + 6.862126139301695*Lt - 3.181318681318681*Lt2)*Wot26 +
  (-3.395147766056077 + 6.693896662603536*Lt - 3.0804597701149423*Lt2)*Wot27 +
  (-3.344022620145584 + 6.532693008853425*Lt - 2.9857142857142858*Lt2)*Wot28 +
  (-3.293035777415732 + 6.378215451024938*Lt - 2.896551724137931*Lt2)*Wot29 +
  (-3.242411258657763 + 6.230156678021733*Lt - 2.8125*Lt2)*Wot30;

  result += 
     (-56.79859308462038 + 180.38149236605148*LmW - 
       122.66666666666667*LmW2 - 14.757810930381288*Lt + 
       21.333333333333332*LmW*Lt - 10.666666666666666*Lt2)*Wo4t + 
     (-88.56967901234567 + 33.37481481481481*LmW - 3.7925925925925927*LmW2 - 
       33.37481481481481*Lt + 7.5851851851851855*LmW*Lt - 
       3.7925925925925927*Lt2)*Wo4t2 + 
     (4.0741068999028185 - 2.5213000755857897*LmW + 0.40634920634920635*
        LmW2 + 2.5213000755857897*Lt - 0.8126984126984127*LmW*Lt + 
       0.40634920634920635*Lt2)*Wo4t3 + 
     (-0.6993474792368665 + 0.5023919076546942*LmW - 0.09631981187536744*
        LmW2 - 0.5023919076546942*Lt + 0.19263962375073487*LmW*Lt - 
       0.09631981187536744*Lt2)*Wo4t4 + 
